...
public class OTSearcher extends SimpleFileVisitor<Path> {
     ...
     * @param logger logger
     */
    OTSearcher(String textToSearch, boolean findOne, final Logger logger) {
    ...
    public static void main(String[] args) {
        ...
        OTSearcher searcher = new OTSearcher(textToSearch, findOne, logger);
