...
public class CalculatorTest {
	...
	public void whenGiveTwoNumbersThenGetTheirSum() {
		...
		calc.add (10, 8);
		assertEquals(18, calc.giveResult(), 1e-3);	
	}
...
/*
	...
	public void whenGiveTwoNumbersThenCantGetUnrightSum() {
		Calculator calc = new Calculator();
		calc.add (10.0, 8.0);
		assertEquals(8.0, calc.giveResult(), 1e-3);	
	}
*/	
	@Test
	public void whenGiveTwoNumbersThenGetTheirSubtraction() {
		Calculator calc = new Calculator();
		calc.sub (10, 8);
		assertEquals(2, calc.giveResult(), 1e-3);	
	}
	...
	public void when_Give_Two_Numbers_Then_Get_Their_Multiplication() {
		Calculator calc = new Calculator();
		calc.mult (10, 8);
		assertEquals(80, calc.giveResult(), 1e-3);	
	}
	...
	public void when_Give_Two_Numbers_Then_Get_Their_Division() {
		Calculator calc = new Calculator();
		calc.div (10, 8);
		assertEquals(1.25, calc.giveResult(), 1e-3);	
	}
	
	@Test
	public void when_Call_GiveResult_Then_Get_Zero() {
		Calculator calc = new Calculator();
		assertEquals(0, calc.giveResult(), 1e-3);	
	}
